...
if __name__ == "__main__":
    ...
    for val_name_i in val_split:
        ...
        for feature_level in range(1, 3):
            ...
            if not os.path.exists(potential_output_file):
                print("potential_output_file not exist", potential_output_file)
                continue

            test_gt_file = os.path.join(source_path, 'scans')
            test_command = f'python test_ply_3d.py --gs_path {potential_output_file} --gt_path_root {test_gt_file}'
