#!/bin/bash
#SBATCH --job-name=autoencder_scannetpp_30_40
#SBATCH --output=sbatch_log/autoencder_scannetpp_30_40_%j.out
#SBATCH --nodes=1
...
python autoencoder_jobs.py  --start_idx 30 --end_idx 40
