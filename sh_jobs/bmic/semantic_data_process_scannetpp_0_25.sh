#!/bin/bash
#SBATCH --job-name=semantic_data_process_scannetpp_0_25
#SBATCH --output=sbatch_log/semantic_data_process_scannetpp_0_25_%j.out
#SBATCH --nodes=1
...
python render_scannetpp_semantics.py --start_idx 0 --end_idx 25
