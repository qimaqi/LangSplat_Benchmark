...
# python train.py -s /usr/bmicnas02/data-biwi-01/qimaqi_data/workspace/neurips_2025/LangSplat_Qi/data/lerf_ovs/ramen -m output/ramen --start_checkpoint /usr/bmicnas02/data-biwi-01/qimaqi_data/workspace/neurips_2025/gaussian-splatting/output/d3f377e5-a/chkpnt30000.pth --feature_level 1

python train.py -s /usr/bmicnas02/data-biwi-01/qimaqi_data/workspace/neurips_2025/LangSplat_Qi/data/lerf_ovs/ramen -m output/ramen --start_checkpoint /usr/bmicnas02/data-biwi-01/qimaqi_data/workspace/neurips_2025/gaussian-splatting/output/d3f377e5-a/chkpnt30000.pth --feature_level 2


# python train.py -s /usr/bmicnas02/data-biwi-01/qimaqi_data/workspace/neurips_2025/LangSplat_Qi/data/lerf_ovs/ramen -m output/ramen --start_checkpoint /usr/bmicnas02/data-biwi-01/qimaqi_data/workspace/neurips_2025/gaussian-splatting/output/d3f377e5-a/chkpnt30000.pth --feature_level 2

# python train.py -s /usr/bmicnas02/data-biwi-01/qimaqi_data/workspace/neurips_2025/LangSplat_Qi/data/lerf_ovs/ramen -m output/ramen --start_checkpoint /usr/bmicnas02/data-biwi-01/qimaqi_data/workspace/neurips_2025/gaussian-splatting/output/d3f377e5-a/chkpnt30000.pth --feature_level 3
